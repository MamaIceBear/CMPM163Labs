...
The formula is x = (u (u-value from uv coordinate) * texture pixel size (in this case it's 8)) - 1

b. What is the formula given a v value of the uv coordinate (a value between 0 and 1), I get the y value of the pixel to 
sample from in this 8x8 texture?
The formula is y = (v (v-value from uv coordinate) * texture pixel size (in this case it's 8)) - 1
